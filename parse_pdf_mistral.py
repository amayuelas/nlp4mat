...
def main(input_dir: str, output_base_dir: str, batch_mode: bool = False):
    ...
    if batch_mode:
        create_batch_file(input_path, output_path, pdf_files, client)
    else:
        for pdf_file in pdf_files:
            try:
                process_pdf(pdf_file, input_path, output_path, client)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir", type=str, required=True, help="Directory containing PDF files to process")
    ...
    main(args.input_dir, args.output_base_dir, args.batch)
